...
%SMR todo: Confirm the T ranges in Ahunbay2004
...
\node [block,below of=step2,node distance=1cm] (stepstep) {\scriptsize Calculate $B_2^\mathrm{IT}$ (Eq.~\ref{eqn:Z1rhoB2B3}), $B_2^\mathrm{sat}$ correlation (Section~\ref{sec:VirialCalc})};
\node [block,below of=stepstep,node distance=1cm] (step3) {\scriptsize Pick an IC from Fig.~\ref{fig:ITICpathway} ($\rho_\mathrm{liq}=\rho^\mathrm{IC}$)};
...
\begin{figure*}
\centering
\subfloat[]{\includegraphics[scale=0.30]{Figures/NIST-VAL_FTT_psat.png}}
\subfloat[]{\includegraphics[scale=0.30]{Figures/NIST-VAL_FTT_trho.png}}
\caption{
...
\begin{figure*}
\centering
\subfloat[]{\includegraphics[scale=0.18]{Figures/NIST-VAL_FTT_C12_conv_0_42690.png}}
\subfloat[]{\includegraphics[scale=0.18]{Figures/NIST-VAL_FTF_C12_conv_0_42690.png}}
\caption{
...
\begin{figure*}
\centering
\subfloat[]{\includegraphics[scale=0.18]{Figures/Diverge-C12-FTF-B2+15_rho-048030gcc.png}}
\subfloat[]{\includegraphics[scale=0.18]{Figures/Converge-C12-FTT-B3+15-rho_048030gcc.png}}
\caption{
...
\begin{figure*}
\centering
\subfloat[]{\includegraphics[scale=0.22]{Figures/FSE_TraPPE-C2_Lammps-rigid_IT.png}}
\subfloat[]{\includegraphics[scale=0.22]{Figures/FSE_TraPPE-C2_Lammps-flex_IT.png}}
\subfloat[]{\includegraphics[scale=0.22]{Figures/FSE_TraPPE-C2_GOMC_IT.png}}
\caption{
...
%\cite{Martin1998,eggimann2014,Potoff2009,Shen2008}. 
...
\begin{figure*}
\centering
\subfloat[]{\includegraphics[scale=0.30]{Figures/EXAMPLE-SIM_TraPPE-C2_C12_iC4_psat.png}}\label{aa}
\subfloat[]{\includegraphics[scale=0.30]{Figures/EXAMPLE-SIM_TraPPE-C2_C12_iC4_trho.png}}\label{bb}\\
\subfloat[]{\includegraphics[scale=0.30]{Figures/EXAMPLE-SIM_Mie-C12_TIP4P_TraPPE-iC6_psat.png}}\label{cc}
\subfloat[]{\includegraphics[scale=0.30]{Figures/EXAMPLE-SIM_Mie-C12_TIP4P_TraPPE-iC6_trho.png}}\label{dd}
\caption{
...
%\begin{figure}
%\includegraphics[scale=0.30]{Figures/EXAMPLE-SIM_TraPPE-C2_C12_iC4_psat.png}
...
%\begin{figure}
%\includegraphics[scale=0.30]{Figures/EXAMPLE-SIM_TraPPE-C2_C12_iC4_trho.png}
...
%\caption{$P^{\mathrm{sat}}$ plot of TraPPE-UA ethane. The virial expansion shown in Eq.~(\ref{eqn:eqn11}) was truncated at the $B_2$ term. GEMC data were obtained from Ref.~\cite{Martin1998}.}
%\label{fig:EXAMPLE-SIM/TraPPE-C2/Psat}
%\end{figure}

%\begin{figure}[h]
%\includegraphics[scale=0.30]{Figures/EXAMPLE-SIM_TraPPE-C2_trho.png}
%\caption{Coexistence curves for TraPPE-UA ethane. The virial expansion shown in Eq.~(\ref{eqn:eqn11}) was truncated at the $B_2$ term. GEMC data were obtained from Ref.~\cite{Martin1998}.}
...
%\caption{$P^{\mathrm{sat}}$ plot of TraPPE-UA \textit{n}-dodecane. The virial expansion shown in Eq.~(\ref{eqn:eqn11}) was truncated at the $B_2$ term. GEMC data were obtained from Ref.~\cite{Martin1998}.}
%\label{fig:EXAMPLE-SIM/TraPPE-C12/Psat}
%\end{figure}

%\begin{figure}
%\includegraphics[scale=0.30]{Figures/EXAMPLE-SIM_TraPPE-C12_trho.png}
%\caption{Coexistence curves for TraPPE-UA \textit{n}-dodecane. The virial expansion shown in Eq.~(\ref{eqn:eqn11}) was truncated at the $B_2$ term. GEMC data were obtained from Ref.~\cite{Martin1998}.}
...
%\begin{figure}
%\includegraphics[scale=0.30]{Figures/EXAMPLE-SIM_Mie-C12_TIP4P_TraPPE-iC6_psat.png}
%\caption{Comaprison between Clausius-Clapeyron plot of Mie-UA \textit{n}-dodecane, TIP4P/2005 water, and TraPPE-UA isohexane obtained using ITIC and GCMC methods. GCMC data of Mie-UA and TraPPE-UA were obtained from Potoff's work\cite{Potoff2009} \cite{Mick2017} and GCMC data of TIP4P/2005 water were obtained from NIST Standard Reference Simulation website \cite{Shen2008}. $B_2$ values at saturation temperatures for Mie-UA \textit{n}-dodecane and TraPPE-UA isohexane were obtained using low density simulations (Figure~\ref{fig:EXAMPLE-SIM/Mie-C12/Z_rho}). These values for TIP4P/2005 water were obtained from Benjamin et al.\cite{Benjamin2007} and Chiavo et al. \citep{Chialvo2006}}
%\label{fig:EXAMPLE-SIM/Mie-C12-TIP4P/Psat}
%\end{figure}

%\begin{figure}
%\includegraphics[scale=0.30]{Figures/EXAMPLE-SIM_Mie-C12_TIP4P_TraPPE-iC6_trho.png}
%\caption{Comaprison between Coexistence curves of Mie-UA \textit{n}-dodecane, TIP4P/2005 water, and TraPPE-UA isohexane obtained using ITIC and GCMC methods.}
%\label{fig:EXAMPLE-SIM/Mie-C12-TIP4P/T_rho}
%\end{figure}
