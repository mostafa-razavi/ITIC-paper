...
Calculate $A^\mathrm{dep}$ based on $T^\mathrm{sat}=T^\mathrm{sat}_\mathrm{est}$ (Eq.~\ref{eqn:AdepLiq2})};
...
Calculate $U^\mathrm{dep}_\mathrm{new}$ from $U^\mathrm{dep}$ vs. $1/T$, i.e., $U^\mathrm{dep}(T^\mathrm{sat}_\mathrm{new})$ };
